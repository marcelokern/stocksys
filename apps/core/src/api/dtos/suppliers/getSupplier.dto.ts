export interface IGetSupplierDto {
    id: string;
    cnpj: string;
...
export class GetSupplierDto implements IGetSupplierDto {
    ...
    constructor({ id, cnpj, corporateName, phone, email, zipcode, street, neighborhood, addressNumber, addressComplement, city, uf }: IGetSupplierDto) {
